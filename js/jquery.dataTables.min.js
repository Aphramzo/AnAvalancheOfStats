...
jQuery.fn.dataTableExt.oSort['numeric-time-asc']  = function(a,b) {
    var x = (trim(a) == "") ? 99999999999 : a.replace( /:/g, "" );
    var y = (trim(b) == "") ? 99999999999 : b.replace( /:/g, "" );
    x = parseFloat( x );
    y = parseFloat( y );
    return ((x < y) ? -1 : ((x > y) ?  1 : 0));
};
 
jQuery.fn.dataTableExt.oSort['numeric-time-desc'] = function(a,b) {
    var x = (trim(a) == "") ? 99999999999 : a.replace( /:/g, "" );
    var y = (trim(b) == "") ? 99999999999 : b.replace( /:/g, "" );
    x = parseFloat( x );
    y = parseFloat( y );
