<%@ Page  MasterPageFile="~/Master/Main.master" Language="C#" AutoEventWireup="true" CodeFile="Players.aspx.cs" Inherits="Players" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Player Stats by Season</title>
...
<asp:Content ID="Content3" ContentPlaceHolderID="explainingColumn" runat="server">
        ...
        <ul>
            ...
            <li>
                Goals per Game:  The players goal total for the season divided by the number of games the player played in.  All "per Game" columns are calculated this way.  If Player Totals is selected, it is the total goals they scored divided by the total number of games they played in.
            </li>
        </ul>
